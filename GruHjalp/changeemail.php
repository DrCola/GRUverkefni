...
if (isset($_SESSION['name']) && $_SESSION['name'] == true) {
 ...
 <form action="include/changeemail.php" method="post" enctype="multipart/form-data">
<td><label>Nýtt email</label></td>
<label>nytt email</label>
<input name="email" type="text"></br>

<input type="submit" value="Skipta um email" name="submit">
</form>

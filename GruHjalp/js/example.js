$(function() {
  ...
  $newItemForm.on('click', function(e) {       // When a new item is submitted
    e.preventDefault();                         // Prevent form being submitted
    var text = $('input:text').val();           // Get value of text input
    $list.append('<li>' + text + '</li>');
    $( "her" ).before( document.createTextNode( "Hello" )  );      // Add item to end of the list
  ...
  $list.on('click', 'li', function() {
    ...
    if (complete === true) {           // Check if item is complete
     $newItemForm.on('click', function(e) {       // When a new item is submitted
    e.preventDefault();                         // Prevent form being submitted
    var text = $('text').val();           // Get value of text input
    $list.append('<li>' + text + '</li>');      // Add item to end of the list
    $( "her" ).before( document.createTextNode( "Hello" )  );
